...
% {NCSTAR}
\newcommand{\pubnumber}{NIST TN 24xx}
\newcommand{\DOI}{https://doi.org/10.6028/NIST.TN.24xx}
\newcommand{\pubmonth}{September}
\newcommand{\pubyear}{2024}
%\newcommand{\erratadate}{09-30-2022}
\newcommand{\pubtitle}{Breaker Fires in Electrical Cabinets --- Calorimetric Analysis (BECCA-Fire)}
